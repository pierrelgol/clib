...
static uint64_t	string_len_or_sentinel(const uint8_t *src, int32_t sentinel)
{
...
uint64_t	string_slcopy(uint8_t *dst, const uint8_t *src, int32_t sentinel,
		uint64_t dsize)
{
	uint64_t	i;
